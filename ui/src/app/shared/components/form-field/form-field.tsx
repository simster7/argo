        ...
        <div>
            <FormComponent
                ...
                className={classNames({
                    'argo-field': true,
                    'argo-has-value': !!getNestedField(props.formApi.values, props.field)
                })}
            />

            {props.label && (
                <label htmlFor={id} className='argo-label-placeholder'>
                    {props.label}
                </label>
            )}
            {getNestedField(props.formApi.touched, props.field) && props.formApi.errors[props.field] && (
                <div className='argo-form-row__error-msg'>{props.formApi.errors[props.field]}</div>
            )}
        </div>
    );
};
