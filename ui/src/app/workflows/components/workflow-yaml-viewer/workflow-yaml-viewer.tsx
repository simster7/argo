...
export class WorkflowYamlViewer extends React.Component<WorkflowYamlViewerProps> {
    ...
    public render() {
        ...
        const html = this.props.workflow.spec.templates
            .map(item => {
            ...
            .join('\n\n');
        return <div className='workflow-yaml-viewer' dangerouslySetInnerHTML={{__html: html}} ref={container => (this.container = container)} />;
    }
        ...
        if (this.props.selectedNode) {
            setTimeout(() => {
                ...
                if (viewerHighlight) {
                    ...
                    Utils.scrollTo(parent, viewerHighlight.offsetTop + parent.scrollTop - window.pageYOffset - parent.clientHeight / 2);
                }
            });
        }
    }
