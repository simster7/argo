...
export class WorkflowTimeline extends React.Component<WorkflowTimelineProps, WorkflowTimelineState> {
    ...
    public render() {
        ...
        return (
            <div
                ...
                style={{
                    width: Math.max(this.state.parentWidth, MIN_WIDTH) + NODE_NAME_WIDTH
                }}>
                ...
                {groups.map(group => [
                    ...
                    ...group.nodes.map(node => (
                        <div
                            key={node.id}
                            className={classNames('workflow-timeline__row', {
                                'workflow-timeline__row--selected': node.id === this.props.selectedNodeId
                            })}
    ...
    public updateWidth() {
        if (this.container) {
            this.setState({
                parentWidth: (this.container.offsetParent || window.document.body).clientWidth - NODE_NAME_WIDTH
            });
        }
    }
