...
func NewContext(wftmplGetter WorkflowTemplateNamespacedGetter, cwftmplGetter ClusterWorkflowTemplateGetter, tmplBase wfv1.TemplateHolder, storage *wfv1.Workflow) *Context {
	return &Context{
...
// NewContext returns new Context.
func NewContextFromClientset(wftmplClientset typed.WorkflowTemplateInterface, clusterWftmplClient typed.ClusterWorkflowTemplateInterface, tmplBase wfv1.TemplateHolder, storage *wfv1.Workflow) *Context {
	return &Context{
...
func (ctx *Context) ResolveTemplate(tmplHolder wfv1.TemplateCaller) (*Context, *wfv1.Template, bool, error) {
...
func (ctx *Context) resolveTemplateImpl(tmplHolder wfv1.TemplateCaller, depth int) (*Context, *wfv1.Template, bool, error) {
	...
	// templateStored is a flag that tracks whether a template has been stored in this resolution
